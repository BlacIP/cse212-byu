...
public static class Recursion
{
    ...
    public static void SolveMaze(List<string> results, Maze maze, int x = 0, int y = 0, List<ValueTuple<int, int>>? currPath = null)
    {
        ...
        // ADD CODE HERE
        if (currPath.Any(p => p.Item1 == x && p.Item2 == y))
        return;
        ...
        var directions = new List<(int, int)> { (0, 1), (1, 0), (-1, 0), (0, -1) };
        ...
        currPath.RemoveAt(currPath.Count - 1);  // Backtrack after exploring all options
